...
deb: packaging/gsuf
	...
	@./packaging/gsuf/gsuf.py --is-dirty; RET=$$?; echo "Dirty: $${RET}"; if [ $${RET} -eq 0 ]; then echo "Project working directory is dirty, will not build package now"; exit 1; else echo "Project working directory is clean"; fi
